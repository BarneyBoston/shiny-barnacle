...
def reset_activities():
    ...
    original_activities = {
        "Soccer Team": {
            "description": "Develop teamwork and soccer skills through training and matches",
        ...
        "Debate Team": {
            "description": "Build public speaking and critical reasoning through structured debates",
            "schedule": "Mondays, 3:30 PM - 5:00 PM",
            "max_participants": 14,
            "participants": ["charlotte@mergington.edu", "james@mergington.edu"]
        },
        "Science Olympiad": {
            "description": "Collaborate on science challenges and prepare for academic competitions",
...
class TestGetActivities:
    ...
    def test_activity_structure(self, client):
        ...
        assert soccer["max_participants"] == 24
...
class TestUnregisterFromActivity:
    ...
    def test_unregister_success(self, client):
        ...
        client.post("/activities/Soccer Team/signup?email=temp@mergington.edu")
        
        # Then unregister
        response = client.delete(
            "/activities/Soccer Team/unregister?email=temp@mergington.edu"
        )
        assert response.status_code == 200
        data = response.json()
        ...
        activities_response = client.get("/activities")
        activities_data = activities_response.json()
        assert "temp@mergington.edu" not in activities_data["Soccer Team"]["participants"]
    ...
    def test_unregister_existing_participant(self, client):
        ...
        activities_response = client.get("/activities")
        activities_data = activities_response.json()
        assert "liam@mergington.edu" not in activities_data["Soccer Team"]["participants"]
